...
var fullMenuPermissions = []MenuPermission{
	...
	{ID: "industry-prompts", Label: "行业提示词", Path: "/industry-prompts", Icon: "sparkles", Order: 35},
...
var apiPermissionCatalog = []APIPermission{
	...
	apiPermission("GET", "/api/admin/industry-prompts", "查看行业提示词库", "行业提示词", true),
	apiPermission("POST", "/api/admin/industry-prompts", "创建/修改行业提示词", "行业提示词", true),
	apiPermission("PATCH", "/api/admin/industry-prompts", "创建/修改行业提示词", "行业提示词", true),
	apiPermission("DELETE", "/api/admin/industry-prompts", "删除行业提示词", "行业提示词", true),
